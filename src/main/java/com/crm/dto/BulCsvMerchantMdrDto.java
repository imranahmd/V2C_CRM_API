...
public class BulCsvMerchantMdrDto {
	...
	private Double aggr_mdr;
	private Double reseller_mdr;
	private Double base_rate;
	private Double min_base_rate;
	private Double max_base_rate;
	private Double min_mdr;
	private Double max_mdr;
	private String mid;
	private String tid;
	...
	public Double getAggr_mdr() {
		return aggr_mdr;
	}
	public void setAggr_mdr(Double aggr_mdr) {
		this.aggr_mdr = aggr_mdr;
	}
	public Double getReseller_mdr() {
		return reseller_mdr;
	}
	public void setReseller_mdr(Double reseller_mdr) {
	...
	public Double getMin_base_rate() {
		return min_base_rate;
	}
	public void setMin_base_rate(Double min_base_rate) {
		this.min_base_rate = min_base_rate;
	}
	public Double getMax_base_rate() {
		return max_base_rate;
	}
	public void setMax_base_rate(Double max_base_rate) {
		this.max_base_rate = max_base_rate;
	}
	public Double getMin_mdr() {
		return min_mdr;
	}
	public void setMin_mdr(Double min_mdr) {
		this.min_mdr = min_mdr;
	}
	public Double getMax_mdr() {
		return max_mdr;
	}
	public void setMax_mdr(Double max_mdr) {
	...
	public int getInstrument_brand() {
		return instrument_brand;
	}
	public void setInstrument_brand(int instrument_brand) {
